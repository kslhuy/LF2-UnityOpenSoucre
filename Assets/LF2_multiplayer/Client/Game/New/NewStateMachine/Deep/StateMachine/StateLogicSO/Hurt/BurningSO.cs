...
namespace LF2.Client{
    ...
    [CreateAssetMenu(fileName = "Burning", menuName = "StateLogic/Common/Hurt/Burning")]
    public class BurningSO : StateLogicSO<BurningLogic>
    {
    ...
    public class BurningLogic : StateActionLogic
    {
