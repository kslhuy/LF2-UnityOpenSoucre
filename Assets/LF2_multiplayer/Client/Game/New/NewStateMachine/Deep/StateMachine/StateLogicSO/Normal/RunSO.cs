...
namespace LF2.Client{
    ...
    public class RunLogic : StateActionLogic
    {
        ...
        public override void PlayAnim(int nbAniamtion = 1, bool sequen = false)
        {
            ...
            base.PlayAnim();
            stateMachineFX.m_ClientVisual.NormalAnimator.Play("Run_anim");
            flip =  stateMachineFX.CoreMovement.FacingDirection == 1 ? false : true ;
        ...
        public override void LogicUpdate()
        {
            ...
            if ( stateMachineFX.InputZ > 0.9f || stateMachineFX.InputZ < -0.9f  ){
