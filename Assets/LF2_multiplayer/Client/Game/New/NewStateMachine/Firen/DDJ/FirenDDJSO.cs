    ...
    public class FirenDDJLogic : LaunchProjectileLogic
    {
        ...
        public override void LogicUpdate()
        {
            ...
            if (Time.time - timeNow >  tickRate){
                ...
                projectile.GetComponent<ProjectileLogic>().Initialize(stateMachineFX.m_ClientVisual.NetworkObjectId,stateMachineFX.team ,new Vector3( stateMachineFX.CoreMovement.FacingDirection ,0,0) ,in projectileInfo);

                var projectile2 = GameObject.Instantiate(projectileInfo.ProjectilePrefab, projectile.transform.position + distanceBtw  + new Vector3(projectileInfo.pivot.x * stateMachineFX.CoreMovement.FacingDirection ,projectileInfo.pivot.y,projectileInfo.pivot.z) ,playerPOS.rotation);
                projectile2.GetComponent<ProjectileLogic>().Initialize(stateMachineFX.m_ClientVisual.NetworkObjectId,stateMachineFX.team,new Vector3( stateMachineFX.CoreMovement.FacingDirection ,0,0) ,in projectileInfo);
        ...
        public override void OnAnimEvent(int id)
        {
            ...
            //     if (damageable != null && damageable.IsDamageable() && damageable.NetworkObjectId != stateMachineFX.m_ClientVisual.NetworkObjectId){
