...
namespace LF2.Client
{
    ...
    public class CharacterSwap : MonoBehaviour
    {
        ...
        public class CharacterModelSet
        {
            ...
            public AnimatorOverrideController Injury_animatorOverrides; // references a separate stand-alone object in the project
        ...
        [SerializeField]
        private Animator m_InjuryAnimator;
        ...
        private void Awake()
        {
            ...
            m_InjuryAnimator = m_ClientCharacterVisualization.InjuryAnimator;
        ...
        public void SwapToModel()
        {
            ...
            if (m_NormalAnimator)
            {
                ...
                if (m_CharacterModel.Normal_animatorOverrides && m_CharacterModel.Injury_animatorOverrides )
                {
