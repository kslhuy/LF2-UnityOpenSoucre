...
namespace LF2.Client
{
    ...
    public class AIBrain : NetworkBehaviour {
        ...
        public StateActionAI_SO stateActionAI_SO;
        ...
        private bool repeat;
        private int _MethodeChoseFoe = 1;
        ...
        public override void OnNetworkSpawn()
        {
            ...
            initPosition = self_transform.position;
        ...
        private void Update() {
            ...
            if (m_BrainEnabled){
                ...
                if (_selectedFoe == null ) {
                    // Case all Player Are Died , So do nothing  
                
                    // var dir = new Vector2(UnityEngine.Random.Range(-1,2) , UnityEngine.Random.Range(-1,2)).normalized;
...
// Refer to this logic 
   ...
   //7: closest beer
        ...
        public IEnumerator Coro_DoReapeatState (StateType state){
            
            while (repeat){
                Do(state);
                var _stateQueue = Self.MStateMachinePlayerViz.GetState(state);

                yield return new WaitForSeconds( _stateQueue.stateData.ReuseTimeSeconds);
            }
