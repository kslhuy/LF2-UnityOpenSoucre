...
namespace LF2
{
    ...
    [SerializeField] string  JumpBack2 = "JumpBack2_anim";
    ...
    [SerializeField] string RunJumpAttack = "Run_Jump_Attack_anim";


    
    [Header("------------ Hurt -------------")]
    [SerializeField] string Defense = "Defense_anim";
    [SerializeField] string DefenseHit = "DefenseHit_anim";

    [SerializeField] string BrokenDefense = "BrokenDefense_anim";
    ...
    [SerializeField] [HideInInspector] public int a_JumpBack1;
    [SerializeField] [HideInInspector] public int a_JumpBack2;
    ...
    [SerializeField] [HideInInspector] public int a_Defend;
    [SerializeField] [HideInInspector] public int a_DefendHit;
    [SerializeField] [HideInInspector] public int a_BrokenDefend;
    ...
    void OnValidate()
    {
        ...
        a_JumpBack1= Animator.StringToHash(JumpBack1);
        a_JumpBack2= Animator.StringToHash(JumpBack2);
        ...
        a_Run_Jump_Attack = Animator.StringToHash(RunJumpAttack);




        //-----------------------------
        a_Defend = Animator.StringToHash(Defense);
        a_DefendHit = Animator.StringToHash(DefenseHit);
        a_BrokenDefend = Animator.StringToHash(BrokenDefense);
