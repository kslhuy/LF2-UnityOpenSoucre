...
//         [Serializable]
//         public class AnimatorNodeEntryEvent
//         {
...
//         public AnimatorNodeEntryEvent[] m_EventsOnNodeEntry;
...
//                 m_Animator = m_ClientCharacterVisualization.NormalAnimator;
//             }
//         }
...
//                     {
//                         // m_AudioSources[0].clip = info.m_SoundEffect;
//                         // m_AudioSources[0].Play();

//                         // Debug.Log(info.m_SoundEffect);
//                         // m_AudioSources[0].PlayOneShot(info.m_SoundEffect);
...
//         // private async Task  DoLoop1Soucre(){
//         //     if (eventInfo.m_LoopSound1Source){
//         //         if (eventInfo.soundLoop1Soucres == null){
//         //             Debug.LogWarning($"{name} doesn't have soundLoop1Soucres. ");
//         //             yield break;
//         //         }
//         //         Debug.Log("Call loopSound");
//         //         float startTime = Time.time;
//         //         while(Time.time - startTime < eventInfo.soundLoop1Soucres.m_LoopSeconds) {
//         //             startTime = Time.time;
//         //             m_AudioSources[0].PlayOneShot(eventInfo.soundLoop1Soucres.m_SoundEffect, eventInfo.m_VolumeMultiplier);
//         //         }
//         //     }
//         // }

//         // public async Task PlaySequence(AnimatorNodeEntryEvent eventInfo){
//         //     float start  = Time.time ; 
//         //     // Debug.Log(Time.time);
//         //     while (Time.time - start <  eventInfo.soundLoop1Soucres.m_LoopSeconds){
//         //         m_AudioSources[0].PlayOneShot(eventInfo.soundLoop1Soucres.m_SoundEffect, eventInfo.m_VolumeMultiplier);
//         //         await Task.Yield();
//         //     }
//         // }

//         // public async void DoLoop1Soucre (AnimatorNodeEntryEvent eventInfo){
//         //     await PlaySequence(eventInfo);
//         // }
