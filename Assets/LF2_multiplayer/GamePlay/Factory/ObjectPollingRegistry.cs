...
namespace LF2.ObjectPool
{
    ...
    /// </summary>
    [CreateAssetMenu(fileName = "ObjectPollingRegistry", menuName = "Polling/ObjectPollingRegistry")]
    public class ObjectPollingRegistry : ScriptableObject{

        public List<ConfigObjectPollingSO> PooledPrefabsList ;
