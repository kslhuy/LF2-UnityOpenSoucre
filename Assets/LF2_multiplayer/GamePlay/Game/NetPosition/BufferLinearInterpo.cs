...
namespace LF2
{
    ...
    public abstract class BufferedLinearInterpo<T> where T : struct
    {
    ...
    public class BufferedLinearInterFloat : BufferedLinearInterpo<float>
    {
    ...
    public class BufferedLinearInterQuaternion : BufferedLinearInterpo<Quaternion>
    {
