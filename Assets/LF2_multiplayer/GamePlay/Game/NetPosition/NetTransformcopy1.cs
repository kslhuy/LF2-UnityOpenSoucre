...
namespace LF2
{
    ...
    public class NetTransformcopy1 : NetworkBehaviour
    {
        ...
        private void TryCommitValuesToServer(Vector3 position, Vector3 rotation, double dirtyTime)
        {
        ...
        private (bool isDirty, bool isPositionDirty, bool isRotationDirty) ApplyTransformToNetworkStateWithInfo(ref NetTransformState networkState, double dirtyTime, Transform transformToUse)
        {
        ...
        private (bool isDirty, bool isPositionDirty, bool isRotationDirty) ApplyTransformToNetworkStateWithInfo(ref NetTransformState networkState, double dirtyTime, Vector3 position, byte rotAnglesY)
        {
            var isDirty = false;
        ...
        public void Teleport(Vector3 newPosition, Quaternion newRotation)
        {
            ...
            // check server side
            TryCommitValuesToServer(newPosition, newRotationEuler, m_CachedNetworkManager.LocalTime.Time);
            m_LocalAuthoritativeNetworkState.IsTeleportingNextFrame = false;
        }
