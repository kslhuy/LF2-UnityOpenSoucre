...
namespace LF2
{
    public static class StateUtils
    {
        ...
        private static Vector3 size =  new Vector3(0.2f,0.35f,0.5f);
        ...
        {
            return DetectNearbyEntities(!isNPC, isNPC, attacker, out results, range);
        }
        public static int DetectMeleeNoRange(bool isNPC, Collider attacker,out RaycastHit[] results)
        {
            return DetectNearbyEntities(isNPC, isNPC, attacker, out results);
        }
        ...
        /// <param name="results">Place an uninitialized RayCastHit[] ref in here. It will be set to the results array. </param>
        /// <returns></returns>
        public static int DetectNearbyEntities(bool wantPcs, bool wantNpcs, Collider attacker, out RaycastHit[] results, float range = 0)
        {
            ...
            int numResults = Physics.BoxCastNonAlloc(myBounds.center,myBounds.extents,
                attacker.transform.right, s_Hits, Quaternion.identity, range, mask);
        ...
        public static int DetectNearbyEntities(bool wantPcs, bool wantNpcs, BoxCollider attacker, out RaycastHit[] results, float range = 0)
        {
            //this simple detect just does a boxcast out from our position in the direction we're facing, out to the range of the attack.
            ...
            Debug.Log("bound center " + attacker.bounds.center);

            // Vector3 scaleSize = new Vector3(attacker.size.x * attacker.transform.lossyScale)
            int numResults = Physics.BoxCastNonAlloc(attacker.bounds.center,attacker.size/2,
        ...
        /// NetworkCharacterState, and be alive. In the future, it will be any non-dead IHurtBox.
        /// </summary>
    ...
    /// </summary>
    public static class StateConclusion
    {
