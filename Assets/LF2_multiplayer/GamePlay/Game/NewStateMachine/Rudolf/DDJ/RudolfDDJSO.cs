...
namespace LF2.Client{
    ...
    [CreateAssetMenu(fileName = "RudolfDDJ", menuName = "StateLogic/Rudolf/Special/DDJ")]
    public class RudolfDDJSO : StateLogicSO<RudolfDDJLogic>
    {
    ...
    public class RudolfDDJLogic : LaunchProjectileLogic
    {
