...
namespace LF2.Client{
    ...
    [CreateAssetMenu(fileName = "RudolfDUA1", menuName = "StateLogic/Rudolf/Special/DUA1")]
    public class RudolfDUA1SO : StateLogicSO<RudolfDUA1Logic>
    {
    ...
    //// Heal 
    public class RudolfDUA1Logic : StateActionLogic
    {
