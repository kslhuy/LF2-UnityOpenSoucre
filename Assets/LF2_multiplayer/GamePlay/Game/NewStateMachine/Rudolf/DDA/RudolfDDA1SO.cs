...
namespace LF2.Client{
    ...
    [CreateAssetMenu(fileName = "RudolfDDA1", menuName = "StateLogic/Rudolf/Special/DDA1")]
    public class RudolfDDA1SO : StateLogicSO<RudolfDDA1Logic>
    {
...
// Projectle normal 
    public class RudolfDDA1Logic : LaunchProjectileLogic
    {
