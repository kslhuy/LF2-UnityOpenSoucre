...
//             Atk_data.Direction = projectileInfo.new Vector3(ProjectileDamage[0].Dirxyz.x * transform.right.x , ProjectileDamage[0].Dirxyz.y,ProjectileDamage[0].Dirxyz.z) ;
...
//             if (Time.time - timeStart >= DestroyAfterSec){
