...
namespace LF2.Client{
    ...
    [CreateAssetMenu(fileName = "JohnDDA1", menuName = "StateLogic/John/Special/DDA1")]
    public class JohnDDA1SO : StateLogicSO<JohnDDA1Logic>
    {
...
// Projectle normal 
    public class JohnDDA1Logic : LaunchProjectileLogic
    {
