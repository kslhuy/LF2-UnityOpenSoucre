...
namespace LF2.Client{
    ...
    [CreateAssetMenu(fileName = "DennisDDA2", menuName = "StateLogic/Dennis/Special/DDA2")]
    public class DennisDDA2SO : StateLogicSO<DennisDDA2Logic>
    {
...
// Projectle normal 
    public class DennisDDA2Logic : LaunchProjectileLogic
    {
