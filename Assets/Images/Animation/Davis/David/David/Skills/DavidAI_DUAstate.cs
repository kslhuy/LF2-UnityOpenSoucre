...
// public class DavidAI_DUAstate : DUAstate
// {
...
//     public DavidAI_DUAstate(Player player, StateMachineServer stateMachine, PlayerData playerData, int hashID , SkillsData deep) : base(player, stateMachine, playerData, hashID)
//     {
//         this.deep = deep;
//         this.hashID = hashID;
//     }
